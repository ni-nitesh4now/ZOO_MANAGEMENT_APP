%include "/home/Downloads/joey_lib_io_v9_release.asm"
...
section .data
    ...
    enter_present_year db "Enter present year: ", 0
    enter_present_month db "Enter present month: ", 0
    
    enter_bid db "Enter the Badger ID: ",10, 0
    enter_name db "Enter the Badger Name: ",10, 0
    enter_sett db "Enter the Badger Home Sett: ",10, \
                                               "1 Settfield", 10, \
                                               "2 Badgerton", 10, \
                                               "3 Stripeville", 10, 0
    enter_mass db "Enter the mass in kilograms (to the nearest whole kg): ",10, 0
    enter_stripes db "Enter the number of Stripes: ",10, 0
    enter_sex db "Enter the Badger sex :", 10, \
                                          "1 Male", 10, \
                                          "2 Female", 10, \
                                          "3 Other", 10, 0
                                          
    enter_b_month db "Enter the Badger's month of Birth: ",10, 0
    enter_b_year db "Enter the Badger's year of Birth: ",10, 0
    enter_keeperID db "Enter StaffID of assigned keeper: ",10, 0
                                                                      
    enter_surname db "Enter the Staff surname: ", 0 
    enter_firstname db "Enter the Staff first name: ", 0
    enter_sid db "Enter the Staff ID (Format p0000XXX): ", 0
    enter_dept db "Enter the Staff Department: ", 10, \
							"1 Park Keeper", 10, \
							"2 Gift Shop", 10, \
							"3 Cafe", 10, 0
    enter_salary db "Enter the annual salary: ", 0 
    enter_year db "Enter the year of joining: ", 0
    enter_email db "Enter the Staff Email address: ", 0
    
    enter_staff_delete db "Enter the StaffID to delete the record: ", 0 
    
     printt_bid db "Badger ID (Format b0000XXX): ", 0
     printt_badger_name db "Name: ", 0
     printt_sett db "Home Setting: ", 0
     printt_mass db "Mass: ", 0
     printt_stripe db "Stripes: ", 0
     printt_stripiness db "Stripiness: ", 0
     printt_sex db "Sex: ", 0
     printt_dob db "Date of Birth: ", 0
     printt_age db "Age: ", 0
     printt_keeperID db "Keeper ID: ", 0
     printt_staff_name db "Name: ", 0
     printt_sid db "Staff ID: ", 0
     printt_dept db "Department: ", 0
     printt_start_salary db "Starting Salary: £", 0
     printt_current_salary db "Current salary: £", 0 
     printt_year db "Year of joining: ", 0
     printt_email db "Email: ", 0    

        menu_enter db '---Zoo Management Program---', 10
         db '1 Add User', 10
         db '2 Add Badger', 10
         db '3 Delete User', 10
         db '4 Delete Badger', 10
         db '5 Display All Users', 10
         db '6 Display All Badgers', 10                                  ;   enters to display the menu feature     ;
         db '7 Search and Display Badger by ID', 10
         db '8 Search and Display Staff by ID', 10
         db '0 Exit', 10
         db 'Enter your choice: ',10,0
        menu_len equ $-menu_enter
    
    you_selected db "You selected ", 0
 
    enter_badger_count_full db "Badger list full, delete existing record to continue ", 10, 0
    enter_staff_count_full db "Staff list full, delete existing record to continue ", 10, 0
    enter_staff_not_found db "Staff does not exist", 10, 0
    enter_badger_not_found db "Badger does not exist", 10, 0
    enter_delete_staff_not_found db "No such staff record to delete", 10, 0            ;   Different enters to ask for badger and staff info ;
    enter_delete_badger_not_found db "No such badger record to delete", 10, 0          ;   Also for alert enters   ;
    enter_dept_not_found db "There is no such department", 10, 0
    enter_sid_format_error db "Incorrect StaffID format! format is p0000XXX ", 10, 0       
    enter_bid_format_error db "Incorrect BadgerID format! format is b0000XXX ", 10, 0
    enter_badger_sett_error db "Error! No such badger home setting", 10, 0
    enter_badger_mass_error db "Wrong Badger Mass !", 10 ,0
    enter_badger_stripes_error db "Badger Stripes input error!",10 ,0
    enter_badger_sex_error db "Wrong Input for badger sex", 10, 0
    enter_badger_month_error db "Wrong input for birth month", 10, 0
    enter_sid_not_found db "StaffID not found", 10, 0    
    enter_bid_not_found db "BadgerID not found", 10, 0
    enter_no_staff db "Staff record is empty", 10, 0
    enter_no_badger db "Badger record is empty", 10, 0
    enter_exit db "Now Exiting ", 10, 0   
    
    enter_sid_deleted db "Staff record deleted successfuly", 10, 0
    enter_bid_deleted db "Badger record deleted successfuly", 10 , 0
...
input_staff_info:
        ...
        mov rbx, 0
            ...
            .staff_empty_record_loop:
                ...
                push rax
                mov rdi, enter_staff_count_full
	   ...
	   .input_sid:
		...
		call read_string_new 
			...
			.sid_incorrect:
			mov rdi, enter_sid_format_error
			call print_string_new
			call print_nl_new                ;Function to enter error if the entered StaffID is incorrect (not correct format)
			jmp .input_sid
	...
	.input_dept:
		...
		jle .dept_no_error
		.dept_error:
			mov rdi, enter_dept_not_found
			call print_string_new            ;enters an error for invalid department input (other than 1, 2 or 3)
			jmp .input_dept
		.dept_no_error:
		mov rsi, rax
		mov byte[rcx], al 
...
input_badger_info:
	...
	push rax
	mov rdi, enter_badger_count_full
	call print_string_new
	pop rax
	...
	.badger_counter_inc:
        ...
        .badgerid:
		  ...
		  cmp AL, 0	                  ;If the last byte is null, the filter loop ends
	          je .end_filter_check_bid
                ...
                .bid_incorrect:
		  mov rdi, enter_bid_format_error
		  call print_string_new
		  call print_nl_new               ;enters error message if the BadgerID is incorrect format
		  jmp .badgerid
        ...
        .badgersett:
            ...
            jl .sett_noerror
            .sett_error:
                mov rdi, enter_badger_sett_error
                call print_string_new
                jmp .badgersett
            .sett_noerror:
                mov rsi, rax
        ...
        .badgermass:
            ...
            .badgermass_error:
                mov rdi, enter_badger_mass_error
        ...
        .badgerstripes:
            ...
            .badgerstripes_error:
                mov rdi, enter_badger_stripes_error
        ...
        .badgersex:
            ...
            .badger_sex_error:
                mov rdi, enter_badger_sex_error
        ...
        .badgerbirthmonth:
            ...
            .badger_month_error:
                mov rdi, enter_badger_month_error
                call print_string_new               ;Error for invalid value
...
delete_staff_record:
    ...
    mov rdi, enter_staff_delete
    call print_string_new
    call read_string_new                ;Print the delete enter
    ...
    .end_delete_staff_record:
        cmp rbx, 1
        jne .sid_not_found
        mov rdi, enter_sid_deleted     ;enter the staff record is deleted
        call print_string_new
        call print_nl_new
        jmp .record_deleted
        
    .sid_not_found:
        mov rdi, enter_sid_not_found
...
present_date_input:
    ...
    push rdi
    .year_input:
        mov rdi, enter_present_year
        call print_string_new           ;Function to enter for present year and store it
        call read_uint_new
    ...
    .month_input:
        mov rdi, enter_present_month
        call print_string_new
        call read_uint_new              ;Function to enter for present month and store it 
        cmp rax, 12
        jg .wrong_month
...
menu_enter_function:
    push rdi
    mov rdi, menu_enter        ;Function to print the menu display                    
    call print_string_new
    pop rdi
        ret
...
main:
    ...
    sub rsp, 32
        ...
        .menu_display:
           ...
           call menu_enter_function    ;Calling the menu display
           call read_int_new            ;Take input
           mov rdx, rax
           mov rdi, you_selected        ;Selection enter
           call print_string_new
           mov rdi, rdx
           call print_int_new
           call print_nl_new
        ...
        .option1:
            ...
            mov rdi, enter_staff_count_full        ;Code to call the Staff input function
            call print_string_new
            jmp .menu_display
