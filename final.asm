...
;	(replace /usr/lib/libasm_io.a with actual location of libasm_io.a file) 


; change the path where u placed the joey-lib_v9_release.asm file
%include "/home/malware/asm/joey-lib_v9_release.asm"
...
main: 
  ...
  .option_8:                              
    mov rdx, [current_number_of_badgers]  
    cmp rdx, 0                            
    jg .badger_array_is_not_empty         
    mov rdi, prnt_badg_array_empty        
    call print_string_new
    jmp .menu_loop
